...
This is the canonical repository-level instruction file.

This repository is a skills-first Sui coding-agent skill pack. Agents should activate skills first. The cognition framework is internal support infrastructure.
...
4. Load hidden cognition, harnesses, constitutions, runtime profiles, and review contracts only when the selected skill references them.
